            ...
            >
              ...
              <div>
                ...
                <div className="mb-5">
                  <button
                    type='submit'
                    className="w-full cursor-pointer rounded-lg text-lg border border-orange-500 bg-orange-500 p-3 text-white transition hover:bg-opacity-90">
                    ログイン
                  </button>
                </div>
                ...
                <div className="mb-5">
                  <div onClick={()=>clickRegister()}      
                    className="w-full cursor-pointer rounded-lg border border-bg-meta-3 text-lg bg-slate-700 p-3 text-white transition hover:bg-opacity-90 text-center">
                    アカウントを新規作成
                  </div>
                </div>
                <p
