...
export const getUser = createAsyncThunk("/tokenlogin", async () => {
  const res: AxiosResponse = await axios.get(
    `http://localhost:5001/api/auth/tokenlogin`
  );  
  return res.data;
});
...
export const getAllUsers = createAsyncThunk(
  ...
  async (payload: GetAllUsersPayload) => {    
    ...
    try {
      const res: AxiosResponse = await axios.post(
        `http://localhost:5001/api/auth/getAllUser`
      );
      return res.data;
    } catch (e: any) {
      if (e.response) {
...
export const updatemeet = createAsyncThunk(
  ...
  async (payload) => {
    try {
      ...
      const res: AxiosResponse = await axios.post(
        `http://localhost:5001/api/auth/updatemeet/`+payload.Id,
        {
          payload
        }
      );
...
export const updatework = createAsyncThunk(
  ...
  async (payload) => {
    try {
      const res: AxiosResponse = await axios.post(
        `http://localhost:5001/api/auth/updatework/`+payload.Id,
        {
          payload
        }
      );
...
export const updatewiki = createAsyncThunk(
  ...
  async (payload) => {
    try {
      const res: AxiosResponse = await axios.post(
        `http://localhost:5001/api/auth/updatewiki/`+payload.Id,
        {
          payload
        }
      );
...
export const updatelink = createAsyncThunk(
  ...
  async (payload) => {
    try {
      const res: AxiosResponse = await axios.post(
        `http://localhost:5001/api/auth/updatelink/`+payload.Id,
        {
          payload
        }
      );
